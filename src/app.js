...
app.use(helmet());
app.use(cors({
  origin: ["http://localhost:3000","http://localhost:5173","https://invitation-backend-production-7fe4.up.railway.app","https://invitation-backend-production-7fe4.up.railway.app"], // EXACT frontend origin
  credentials: true
}));
